...
const I18n = (() => {
  ...
  const DICT = {
    es: {
      ...
      'Centimetres (cm)': 'Centímetros (cm)', 'Inches (in)': 'Pulgadas (in)', 'Install FitChecker': 'Instalar FitChecker',
      ...
      'The interface language for FitChecker on this device.': 'El idioma de la interfaz de FitChecker en este dispositivo.',
      ...
      'FitChecker works as an app on your phone:': 'FitChecker funciona como una app en tu teléfono:',
      'Desktop': 'Escritorio',
    ...
    zh: {
      ...
      'Centimetres (cm)': '厘米 (cm)', 'Inches (in)': '英寸 (in)', 'Install FitChecker': '安装 FitChecker',
      ...
      'The interface language for FitChecker on this device.': '本设备上 FitChecker 的界面语言。',
      ...
      'FitChecker works as an app on your phone:': 'FitChecker 可作为应用安装到你的手机上：',
      'Desktop': '电脑',
    ...
    hi: {
      ...
      'Centimetres (cm)': 'सेंटीमीटर (cm)', 'Inches (in)': 'इंच (in)', 'Install FitChecker': 'FitChecker इंस्टॉल करें',
      ...
      'The interface language for FitChecker on this device.': 'इस डिवाइस पर FitChecker की इंटरफ़ेस भाषा।',
      ...
      'FitChecker works as an app on your phone:': 'FitChecker आपके फ़ोन पर ऐप की तरह काम करता है:',
      'Desktop': 'डेस्कटॉप',
    ...
    ar: {
      ...
      'Centimetres (cm)': 'سنتيمتر (cm)', 'Inches (in)': 'بوصة (in)', 'Install FitChecker': 'تثبيت FitChecker',
      ...
      'The interface language for FitChecker on this device.': 'لغة واجهة FitChecker على هذا الجهاز.',
      ...
      'FitChecker works as an app on your phone:': 'يعمل FitChecker كتطبيق على هاتفك:',
      'Desktop': 'سطح المكتب',
    ...
    pt: {
      ...
      'Centimetres (cm)': 'Centímetros (cm)', 'Inches (in)': 'Polegadas (in)', 'Install FitChecker': 'Instalar FitChecker',
      ...
      'The interface language for FitChecker on this device.': 'O idioma da interface do FitChecker neste dispositivo.',
      ...
      'FitChecker works as an app on your phone:': 'O FitChecker funciona como um app no seu telefone:',
      'Desktop': 'Computador',
    ...
    fr: {
      ...
      'Centimetres (cm)': 'Centimètres (cm)', 'Inches (in)': 'Pouces (in)', 'Install FitChecker': 'Installer FitChecker',
      ...
      'The interface language for FitChecker on this device.': 'La langue de l’interface de FitChecker sur cet appareil.',
      ...
      'FitChecker works as an app on your phone:': 'FitChecker fonctionne comme une application sur votre téléphone :',
      'Desktop': 'Ordinateur',
    ...
    de: {
      ...
      'Centimetres (cm)': 'Zentimeter (cm)', 'Inches (in)': 'Zoll (in)', 'Install FitChecker': 'FitChecker installieren',
      ...
      'The interface language for FitChecker on this device.': 'Die Anzeigesprache von FitChecker auf diesem Gerät.',
      ...
      'FitChecker works as an app on your phone:': 'FitChecker funktioniert als App auf deinem Handy:',
      'Desktop': 'Desktop',
    ...
    ru: {
      ...
      'Centimetres (cm)': 'Сантиметры (см)', 'Inches (in)': 'Дюймы (in)', 'Install FitChecker': 'Установить FitChecker',
      ...
      'The interface language for FitChecker on this device.': 'Язык интерфейса FitChecker на этом устройстве.',
      ...
      'FitChecker works as an app on your phone:': 'FitChecker работает как приложение на вашем телефоне:',
      'Desktop': 'Компьютер',
    ...
    ja: {
      ...
      'Centimetres (cm)': 'センチ (cm)', 'Inches (in)': 'インチ (in)', 'Install FitChecker': 'FitChecker をインストール',
      ...
      'The interface language for FitChecker on this device.': 'この端末での FitChecker の表示言語。',
      ...
      'FitChecker works as an app on your phone:': 'FitChecker はスマホのアプリとして使えます：',
      'Desktop': 'パソコン',
    ...
    it: {
      ...
      'Centimetres (cm)': 'Centimetri (cm)', 'Inches (in)': 'Pollici (in)', 'Install FitChecker': 'Installa FitChecker',
      ...
      'The interface language for FitChecker on this device.': 'La lingua dell’interfaccia di FitChecker su questo dispositivo.',
      ...
      'FitChecker works as an app on your phone:': 'FitChecker funziona come un’app sul tuo telefono:',
      'Desktop': 'Computer',
    ...
    sv: {
      ...
      'Centimetres (cm)': 'Centimeter (cm)', 'Inches (in)': 'Tum (in)', 'Install FitChecker': 'Installera FitChecker',
      ...
      'The interface language for FitChecker on this device.': 'Gränssnittsspråket för FitChecker på den här enheten.',
      ...
      'FitChecker works as an app on your phone:': 'FitChecker fungerar som en app på din telefon:',
      'Desktop': 'Dator',
  ...
  const protectedSet = new Set(['FitChecker', 'Translating…']);
  let fetching = false;
